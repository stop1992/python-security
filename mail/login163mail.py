...
class Email163:
    ...
    def login(self, username, passwd):
        ...
        req = urllib2.Request(
            url="https://mail.163.com/entry/cgi/ntesdoor?df=mail163_letter&from=web&funcid=loginone&iframe=1&language=-1&passtype=1&product=mail163&net=c&style=-1&race=58_72_223_gz&uid=" + username,
            # pdmtestmail@163.com"
            data=postdata,
            headers=self.header)
