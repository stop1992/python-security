...
class _STACK(object):
    ...
    __repr__ = _swig_repr
    num = _swig_property(__m2crypto._STACK_num_get, __m2crypto._STACK_num_set)
    data = _swig_property(__m2crypto._STACK_data_get, __m2crypto._STACK_data_set)
    sorted = _swig_property(__m2crypto._STACK_sorted_get, __m2crypto._STACK_sorted_set)
    num_alloc = _swig_property(__m2crypto._STACK_num_alloc_get, __m2crypto._STACK_num_alloc_set)
    comp = _swig_property(__m2crypto._STACK_comp_get, __m2crypto._STACK_comp_set)
    def __init__(self): 
...
class stack_st_OPENSSL_STRING(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    stack = _swig_property(__m2crypto.stack_st_OPENSSL_STRING_stack_get, __m2crypto.stack_st_OPENSSL_STRING_stack_set)
    def __init__(self): 
...
class stack_st_OPENSSL_BLOCK(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    stack = _swig_property(__m2crypto.stack_st_OPENSSL_BLOCK_stack_get, __m2crypto.stack_st_OPENSSL_BLOCK_stack_set)
    def __init__(self): 
...
class _cbd_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    password = _swig_property(__m2crypto._cbd_t_password_get, __m2crypto._cbd_t_password_set)
    prompt = _swig_property(__m2crypto._cbd_t_prompt_get, __m2crypto._cbd_t_prompt_set)
    def __init__(self): 
